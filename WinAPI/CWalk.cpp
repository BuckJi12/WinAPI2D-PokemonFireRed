...
void CWalk::Init()
{
	...
	pPlayer->GetAnimator()->CreateAnimation(L"WalkDown", m_pWalkImage, Vector(0, 0), Vector(64.f, 80.f), Vector(64.f, 0.f), 0.5, 4);
	pPlayer->GetAnimator()->CreateAnimation(L"WalkUP", m_pWalkImage, Vector(0, 80), Vector(64.f, 80.f), Vector(64.f, 0.f), 0.5, 4);
	pPlayer->GetAnimator()->CreateAnimation(L"WalkLeft", m_pWalkImage, Vector(0, 160), Vector(64.f, 80.f), Vector(64.f, 0.f), 0.5, 4);
	pPlayer->GetAnimator()->CreateAnimation(L"WalkRight", m_pWalkImage, Vector(0, 240), Vector(64.f, 80.f), Vector(64.f, 0.f), 0.5, 4);
}

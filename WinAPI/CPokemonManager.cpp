...
void CPokemonManager::Init()
{
	...
	m_mapPokemons.insert(make_pair(17, new CArticuno()));		// 프리져
	m_mapPokemons.insert(make_pair(18, new CZapdos()));			// 썬더
	m_mapPokemons.insert(make_pair(19, new CMoltres()));		// 파이어
	m_mapPokemons.insert(make_pair(20, new CMewtwo()));			// 뮤츠
 }
